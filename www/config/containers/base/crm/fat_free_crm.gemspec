# -*- encoding: utf-8 -*-
$LOAD_PATH.push File.expand_path('/tmp/lib', __FILE__)
require 'contact_rocket_crm/version'

Gem::Specification.new do |gem|
  gem.name = 'contact_rocket_crm'
  gem.authors = ['Peter Alcock']
  gem.summary = 'ContactRocket'
  gem.description = 'An open source, Ruby on Rails customer relationship management platform'
  gem.homepage = 'https://your-server.net'
  gem.email = ['peter@your-server.net']
  gem.files = `git ls-files`.split("\n")
  gem.version = ContactRocketCRM::VERSION::STRING
  ...
  # ContactRocketCRM has released it's own versions of the following gems:
  #-----------------------------------------------------------------
  gem.add_dependency 'ransack_ui',          '>= 1.3.1'
  gem.add_dependency 'ransack',             '~> 1.6.2'
  gem.add_dependency 'email_reply_parser_crcrm'
end
