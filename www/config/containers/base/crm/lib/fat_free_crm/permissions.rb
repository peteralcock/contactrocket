    ...
    module ClassMethods
      def uses_user_permissions
        unless included_modules.include?(InstanceMethods)
          ...
          include ContactRocketCRM::Permissions::InstanceMethods
          extend ContactRocketCRM::Permissions::SingletonMethods
        end
      end
    end
...
end # ContactRocketCRM

ActiveRecord::Base.send(:include, ContactRocketCRM::Permissions)
